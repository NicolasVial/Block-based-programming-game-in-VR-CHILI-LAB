...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* Parser_Parse_m3569CEF6B54818DD39EB0489232172C96D2B998F (String_t* ___jsonString0, const RuntimeMethod* method) ;
// System.String Google.MiniJSON.Json/Serializer::Serialize(System.Object)
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR String_t* Serializer_Serialize_m858D3F7DCD4241391F1450412CC390473BA6DF08 (RuntimeObject* ___obj0, const RuntimeMethod* method) ;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool Parser_IsHexDigit_m751A7A239DCE22ED28C759FB3B9A69DFCFA29E49 (Il2CppChar ___c0, const RuntimeMethod* method) ;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool Parser_IsWordBreak_m09686F47B46EC9875CDF4A6DCB329CFC55681E80 (Il2CppChar ___c0, const RuntimeMethod* method) ;
...
IL_000e:
	{
		...
		RuntimeObject* L_3;
		L_3 = Parser_Parse_m3569CEF6B54818DD39EB0489232172C96D2B998F(L_2, NULL);
		V_1 = L_3;
		goto IL_0017;
	}
...
IL_0041:
	{
		V_5 = (Dictionary_2_tA348003A3C1CEFB3096E9D2A0BC7F1AC8EC4F710*)NULL;
		goto IL_00cf;
	}
...
IL_0050:
	{
		String_t* L_10;
		L_10 = Parser_ParseString_m3A1DBEF95B05BE6518776E820C2361ED7F53EE7D(__this, NULL);
		V_2 = L_10;
		String_t* L_11 = V_2;
...
IL_0067:
	{
		int32_t L_13;
		L_13 = Parser_get_NextToken_m1929B96398C765C1294FEDD658C9DF0B4C95E6CB(__this, NULL);
		V_7 = (bool)((((int32_t)((((int32_t)L_13) == ((int32_t)5))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		bool L_14 = V_7;
		if (!L_14)
		{
			goto IL_007f;
...
IL_007f:
	{
		...
		int32_t L_18 = V_3;
		RuntimeObject* L_19;
		L_19 = Parser_ParseByToken_m2BEF209879EDBD65C33D083E66542063E5850980(__this, L_18, NULL);
		V_4 = L_19;
	...
	{
		int32_t L_21 = V_3;
		G_B20_0 = ((((int32_t)((((int32_t)L_21) == ((int32_t)((int32_t)11)))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		goto IL_00aa;
	}
...
IL_00b5:
	{
		...
		NullCheck(L_23);
		Dictionary_2_set_Item_m7CCA97075B48AFB2B97E5A072B94BC7679374341(L_23, L_24, L_25, Dictionary_2_set_Item_m7CCA97075B48AFB2B97E5A072B94BC7679374341_RuntimeMethod_var);
		goto IL_00c6;
	}
...
IL_003d:
	{
		int32_t L_8 = V_2;
		RuntimeObject* L_9;
		L_9 = Parser_ParseByToken_m2BEF209879EDBD65C33D083E66542063E5850980(__this, L_8, NULL);
		V_4 = L_9;
	...
	{
		int32_t L_11 = V_2;
		G_B13_0 = ((((int32_t)((((int32_t)L_11) == ((int32_t)((int32_t)11)))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		goto IL_0055;
	}
...
IL_0078:
	{
		List_1_tA239CB83DE5615F348BB0507E45F490F4F7C9A8D* L_18 = V_5;
		return L_18;
	}
}
// System.Object Google.MiniJSON.Json/Parser::ParseValue()
...
IL_0059:
	{
		StringReader_t1A336148FF22A9584E759A9D720CC96C23E35DD8* L_10 = __this->___json_2;
		NullCheck(L_10);
		int32_t L_11;
		L_11 = VirtualFuncInvoker0< int32_t >::Invoke(9 /* System.Int32 System.IO.TextReader::Peek() */, L_10);
...
IL_0075:
	{
		Il2CppChar L_13;
		L_13 = Parser_get_NextChar_mAA110522471FA2FCA9D5731BF4FA3B61565D487F(__this, NULL);
		V_1 = L_13;
		Il2CppChar L_14 = V_1;
		V_6 = L_14;
		Il2CppChar L_15 = V_6;
...
IL_00a0:
	...
	{
		Il2CppChar L_20 = V_6;
		if ((((int32_t)L_20) == ((int32_t)((int32_t)98))))
		{
			goto IL_00ed;
		}
	}
...
IL_00b9:
	{
		Il2CppChar L_22 = V_6;
		if ((((int32_t)L_22) == ((int32_t)((int32_t)110))))
		{
			goto IL_0105;
		}
	}
...
IL_00c1:
	{
		Il2CppChar L_23 = V_6;
		switch (((int32_t)il2cpp_codegen_subtract((int32_t)L_23, ((int32_t)114))))
		{
			case 0:
			{
				goto IL_0110;
...
IL_0133:
	{
		CharU5BU5D_t799905CF001DD5F13F7DBB310181FC4D8B7D0AAB* L_38 = V_7;
		int32_t L_39 = V_8;
		Il2CppChar L_40;
		L_40 = Parser_get_NextChar_mAA110522471FA2FCA9D5731BF4FA3B61565D487F(__this, NULL);
		NullCheck(L_38);
		(L_38)->SetAt(static_cast<il2cpp_array_size_t>(L_39), (Il2CppChar)L_40);
		CharU5BU5D_t799905CF001DD5F13F7DBB310181FC4D8B7D0AAB* L_41 = V_7;
		int32_t L_42 = V_8;
		NullCheck(L_41);
		int32_t L_43 = L_42;
		uint16_t L_44 = (uint16_t)(L_41)->GetAt(static_cast<il2cpp_array_size_t>(L_43));
		bool L_45;
		L_45 = Parser_IsHexDigit_m751A7A239DCE22ED28C759FB3B9A69DFCFA29E49(L_44, NULL);
...
IL_015e:
	{
		int32_t L_48 = V_8;
		V_11 = (bool)((((int32_t)L_48) < ((int32_t)4))? 1 : 0);
		bool L_49 = V_11;
		if (L_49)
		{
			goto IL_0133;
	...
	}
	{
		...
		CharU5BU5D_t799905CF001DD5F13F7DBB310181FC4D8B7D0AAB* L_51 = V_7;
		String_t* L_52;
		L_52 = String_CreateString_mFBC28D2E3EB87D497F7E702E4FFAD65F635E44DF(NULL, L_51, NULL);
		il2cpp_codegen_runtime_class_init_inline(Convert_t7097FF336D592F7C06D88A98349A44646F91EFFC_il2cpp_TypeInfo_var);
		int32_t L_53;
		L_53 = Convert_ToInt32_mD1B3AFBDA26E52D0382434804364FEF8BA241FB4(L_52, ((int32_t)16), NULL);
		NullCheck(L_50);
		StringBuilder_t* L_54;
		L_54 = StringBuilder_Append_m71228B30F05724CD2CD96D9611DCD61BFB96A6E1(L_50, ((int32_t)(uint16_t)L_53), NULL);
		goto IL_0181;
	}
...
IL_0183:
	{
		...
		L_57 = StringBuilder_Append_m71228B30F05724CD2CD96D9611DCD61BFB96A6E1(L_55, L_56, NULL);
		goto IL_018d;
	}
...
IL_002d:
	{
		...
		bool L_8;
		L_8 = Parser_IsWordBreak_m09686F47B46EC9875CDF4A6DCB329CFC55681E80(L_7, NULL);
...
IL_0022:
	...
	{
		Il2CppChar L_5 = V_2;
		switch (((int32_t)il2cpp_codegen_subtract((int32_t)L_5, ((int32_t)34))))
		{
			case 0:
			{
				goto IL_00f4;
...
IL_00d4:
	{
		...
		NullCheck(L_12);
		int32_t L_13;
		L_13 = VirtualFuncInvoker0< int32_t >::Invoke(10 /* System.Int32 System.IO.TextReader::Read() */, L_12);
		V_1 = 4;
		goto IL_0143;
	}
...
IL_0100:
	{
		String_t* L_16;
		L_16 = Parser_get_NextWord_m7E1370AB8E0DA6C161CCA5A215F7A9BA1C910376(__this, NULL);
		V_3 = L_16;
		String_t* L_17 = V_3;
		bool L_18;
...
IL_00eb:
	...
	{
		int32_t L_29 = V_4;
		G_B17_0 = ((((int32_t)((((int32_t)L_29) > ((int32_t)((int32_t)126)))? 1 : 0)) == ((int32_t)0))? 1 : 0);
		goto IL_0105;
	}
...
IL_0105:
	...
	{
		StringBuilder_t* L_31 = __this->___builder_0;
		Il2CppChar L_32 = V_2;
		NullCheck(L_31);
...
IL_011c:
	{
		...
		L_35 = StringBuilder_Append_m08904D74E0C78E5F36DCD9C9303BDD07886D9F7D(L_34, _stringLiteralDA666908BB15F4E1D2649752EC5DCBD0D5C64699, NULL);
		StringBuilder_t* L_36 = __this->___builder_0;
		String_t* L_37;
		L_37 = Int32_ToString_m967AECC237535C552A97A80C7875E31B98496CA9((&V_4), _stringLiteralE727BF366E3CC855B808D806440542BF7152AF19, NULL);
		NullCheck(L_36);
...
IL_014e:
	{
		int32_t L_40 = V_1;
		CharU5BU5D_t799905CF001DD5F13F7DBB310181FC4D8B7D0AAB* L_41 = V_0;
		NullCheck(L_41);
		V_6 = (bool)((((int32_t)L_40) < ((int32_t)((int32_t)(((RuntimeArray*)L_41)->max_length))))? 1 : 0);
		bool L_42 = V_6;
		if (L_42)
		{
			goto IL_001d;
	...
	{
		StringBuilder_t* L_43 = __this->___builder_0;
		NullCheck(L_43);
